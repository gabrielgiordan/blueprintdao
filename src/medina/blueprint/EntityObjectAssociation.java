...
final class EntityObjectAssociation extends SimpleEntityAssociation 
								implements Comparable<EntityObjectAssociation>
{

	final Variable variable;

	EntityObjectAssociation(Object next, Object code, Variable variable)
	{
		super(next, code);
		this.variable = variable;
	}

	boolean isCodeEquals(EntityObjectAssociation otherAssociation) 
	{
	...
	@Override
	public int compareTo(EntityObjectAssociation o)
	{
	...
	private static int compareCode(EntityObjectAssociation o1, EntityObjectAssociation o2)
	{
		Class<?> type = o1.code.getClass();
