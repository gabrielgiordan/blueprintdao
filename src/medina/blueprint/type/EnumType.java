...
/**
 * Use this interface on your enum or class
 * implementations to pass it dynamically as an 
 * enum parameter value.
 * 
 * <p>It's equivalent to the <tt>ENUM</tt> 
 * constraint on databases.</p>
 * 
 * <p>The implementation of this class is also
 * needed when using a {@link SetType}
 * class.</p>
 * 
