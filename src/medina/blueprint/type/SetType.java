...
/**
 * The SetType is a an enum type set that
 * restricts the String types on it, which it 
 * can have a maximum of 64 distinct members.
 * 
 * <p>It's equivalent to the <tt>SET</tt> 
 * constraint on databases.</p>
 * 
...
public class SetType<E extends EnumType> extends HashSet<E> {
	...
	/**
	 * Constructs a new set type, using an determined
	 * {@link EnumType} implementation.
	 * 
	 * @author Gabriel Giordano
	 * 
	 * @param type - the enum class type that will be used
	 * on this particular set.
	 * 
	 * @see EnumType
	 */
	public SetType(Class<E> type) {
		super();
	...
	/**
	 * Convert and add a set of types on
	 * the current set.
	 * 
	 * @author Gabriel Giordano
	 * 
	 * @param types - the types separated by comma
	 * and without spaces between then.
	 * 
	 * @see EnumSetType#getAllValues()
	 */
	public void addByComma(String types) {
	...
	/**
	 * Returns a string containing all the types
	 * ordered by comma.
	 * 
	 * @author Gabriel Giordano
