...
public abstract class StatementTool<E> implements StatementBuilder<E>
{
	...
	public StatementTool()
	{
		defaultEntity = 
				...
				(EngineUtil.resolveGenericType(getClass()));
	...
	public String[] getInsertColumns()
	{
		if(!increment)
		{
			...
			(
				"The columns' array are available " +
				"only for auto increment insert generated statements."
			);
		}
		
		String[] insertColumns = insertColumnsArray;
	...
	@Override
	public void useAutoIncrement(boolean increment, String sequence)
	{
		this.increment = increment;
	...
	@Override
	public StatementBuilder<E> select(String... columns)
	{
	...
	@Override
	public Object where(E instance)
	{
		try
		{
			where();
	...
	@Override
	public StatementBuilder<E> where(String... columns)
	{
	...
	@Override
	public Collection<Object> insert(E instance)
	{
	...
	@Override
	public StatementBuilder<E> insert(String... columns)
	{
	...
	@Override
	public Collection<Object> update(E instance)
	{
		final Collection<Object> values = new ArrayList<>();
	...
	@Override
	public StatementBuilder<E> update(String... columns)
	{
		insertColumns.addAll(Arrays.asList(columns));
		return this;
	}
